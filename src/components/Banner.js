...
function Banner(props) {
  return (
    <div>
      ...
      >
        <img
          className="lg:w-[100%] lg:h-[700px]"
          src="https://gismoreview.com/wp-content/uploads/2021/01/img_600f072c0f184.jpg"
          alt="hero"
        />
        <img
          className="lg:w-[100%] lg:h-[700px]"
        ...
        <img
          className="lg:w-[100%] lg:h-[700px]"
          src="https://cdn.mos.cms.futurecdn.net/eG9dwWMNrFwoc4uW4YHS2Z.jpg"
          alt="hero"
        />
      </Carousel>
    </div>
